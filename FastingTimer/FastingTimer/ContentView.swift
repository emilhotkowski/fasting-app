...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            //background
            Color(#colorLiteral(red: 0.05261181295, green: 0, blue: 0.09364337474, alpha: 1))
                .ignoresSafeArea()
        ...
        ZStack {
            ...
            VStack(spacing: 40) {
                ...
                HStack(spacing: 60) {
                    ...
                    VStack(spacing: 5) {
                        Text(
                            fastingManager.fastingState == .notStarted ? "Start" : "Started"
                        )
                            .opacity(0.7)
                    ...
                    VStack(spacing: 5) {
                        Text(
                            fastingManager.fastingState == .notStarted ? "End" : "Ends"
                        )
                            .opacity(0.7)
                ...
                Button {
                    ...
                    Text(
                        fastingManager.fastingState == .fasting ? "End fast" : "Start fasting")
                        .fontWeight(.semibold)
                        .padding(.horizontal, 24)
                        .padding(.vertical, 8)
                        .background(.thinMaterial)
